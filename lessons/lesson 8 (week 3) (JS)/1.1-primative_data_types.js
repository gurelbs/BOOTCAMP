 ...
 */
 ...
 let bill = 114;
 let tax = 1.17;
 let answer = `the answer for ${bill}*${tax} is: ${bill*tax}. -  this is Your total bill`;
 console.log(answer);

// Round the number 50.6 to its nearest integer
let num = 50.6;
let roundNum = Math.round(num)
console.log(`${num} after round is: ${roundNum}`);
//Create a variable that is undefined
let nooo = undefined
console.log(`the variable nooo is:`,typeof nooo);